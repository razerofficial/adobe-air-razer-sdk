...
public class RazerSDKNativeFunctionGetButtonName implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionGetButtonName.class.getSimpleName();
