...
public class RazerSDKNativeFunctionGetAnyButtonDown implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionGetAnyButtonDown.class.getSimpleName();
