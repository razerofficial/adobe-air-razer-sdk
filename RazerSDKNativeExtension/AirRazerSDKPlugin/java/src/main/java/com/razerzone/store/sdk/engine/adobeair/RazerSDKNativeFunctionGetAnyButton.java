...
public class RazerSDKNativeFunctionGetAnyButton implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionGetAnyButton.class.getSimpleName();
