...
public class RazerSDKNativeFunctionPutGameData implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionPutGameData.class.getSimpleName();
