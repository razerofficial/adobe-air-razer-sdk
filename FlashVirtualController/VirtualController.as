package
{
    ...
    public class VirtualController extends MovieClip
    {
		...
		public function Axis(axis:int,val:Number) {
			//_mRazerSDKNativeInterface.LogInfo("Axis: axis:"+axis+" val:"+val);			
		...
		public function ButtonDown(button:int) {
			//_mRazerSDKNativeInterface.LogInfo("ButtonDown: button:"+button);
		...
		public function ButtonUp(button:int) {
			//_mRazerSDKNativeInterface.LogInfo("ButtonUp: button:"+button);
			if (button == Controller.BUTTON_O) {
		...
		public function Update():void
		{
			...
			//_mRazerSDKNativeInterface.LogInfo("***** LX:"+lx+" LY:"+ly+" RX:"+rx+" RY:"+ry+" L2:"+l2+" R2:"+r2);	
		}
    }
}
