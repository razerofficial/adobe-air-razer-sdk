...
public class RazerSDKNativeFunctionGetButton implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionGetButton.class.getSimpleName();
