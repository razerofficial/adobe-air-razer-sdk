...
public class RazerSDKNativeFunctionGetButtonUp implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionGetButtonUp.class.getSimpleName();
