...
public class RazerSDKNativeFunctionGetButtonDown implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionGetButtonDown.class.getSimpleName();
