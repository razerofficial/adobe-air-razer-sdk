...
public class RazerSDKNativeFunctionIsConnected implements FREFunction {
	
	private static final String TAG = RazerSDKNativeFunctionIsConnected.class.getSimpleName();
